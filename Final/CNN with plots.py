...
with tf.Session() as sess:
    ...
    for i in range(epochs):
        ...
        _,c = sess.run([train_step, cross_entropy], feed_dict={x: batch[0], y_: batch[1], keep_prob:0.5})
        epoch_loss += c
        ...
        usps_accuracy = accuracy.eval(feed_dict={x: images_shuf[0:10000,:], y_: labels_shuf[0:10000,:], keep_prob: 1.0})
    ...
    print('USPS test accuracy %g' % accuracy.eval(feed_dict={x: images_shuf[0:10000,:], y_: labels_shuf[0:10000,:], keep_prob: 1.0}))
